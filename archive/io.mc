...
# Creation Date and Time:  Sun Aug  6 20:04:22 2023
...
##############################################################################
# MC-shell I/O capture file.
# Creation Date and Time:  Sun Aug  6 20:05:06 2023
...
NOsh: Storing molecule 0 path barnase.pqr
...
NOsh: Parsing READ section
NOsh: Storing molecule 1 path barstar.pqr
NOsh: Done parsing READ section
...
##############################################################################
# MC-shell I/O capture file.
# Creation Date and Time:  Sun Aug  6 20:07:54 2023
...
Vnm_tstop: stopping timer 30 (Vmgdrv2: fine problem setup).  CPU TIME = 3.727000e-02
...
Vnm_tstop: stopping timer 30 (Vmgdrv2: coarse problem setup).  CPU TIME = 2.919870e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: solve)..
Vnm_tstop: stopping timer 40 (MG iteration).  CPU TIME = 2.588175e+00
Vprtstp: iteration = 0
Vprtstp: relative residual = 1.000000e+00
Vprtstp: contraction number = 1.000000e+00
Vprtstp: iteration = 1
Vprtstp: relative residual = 3.757998e-02
Vprtstp: contraction number = 3.757998e-02
Vprtstp: iteration = 2
Vprtstp: relative residual = 3.895773e-03
Vprtstp: contraction number = 1.036662e-01
Vprtstp: iteration = 3
Vprtstp: relative residual = 4.711726e-04
Vprtstp: contraction number = 1.209446e-01
Vprtstp: iteration = 4
Vprtstp: relative residual = 6.213487e-05
Vprtstp: contraction number = 1.318728e-01
Vprtstp: iteration = 5
Vprtstp: relative residual = 8.809667e-06
Vprtstp: contraction number = 1.417830e-01
Vprtstp: iteration = 6
Vprtstp: relative residual = 1.333059e-06
Vprtstp: contraction number = 1.513177e-01
Vprtstp: iteration = 7
Vprtstp: relative residual = 2.154342e-07
Vprtstp: contraction number = 1.616089e-01
Vnm_tstop: stopping timer 30 (Vmgdrv2: solve).  CPU TIME = 9.744516e+00
Vnm_tstop: stopping timer 28 (Solver timer).  CPU TIME = 1.023128e+01
...
Vgrid_writeDX:  Writing to virtual socket...
Vgrid_writeDX:  Writing comments for ASC format.
Vnm_tstop: stopping timer 26 (APBS WALL CLOCK).  CPU TIME = 1.357206e+01
##############################################################################
# MC-shell I/O capture file.
# Creation Date and Time:  Sun Aug  6 20:11:22 2023
...
Vpmg_fillco:  marking ion and solvent accessibility.
fillcoCoef:  Calling fillcoCoefMol...
Vacc_SASA: Time elapsed: 0.000403
Vpmg_fillco:  done filling coefficient arrays
Vpmg_fillco:  filling boundary arrays
Vpmg_fillco:  done filling boundary arrays
Vnm_tstop: stopping timer 27 (Setup timer).  CPU TIME = 2.138777e+00
Vnm_tstart: starting timer 28 (Solver timer)..
Vnm_tstart: starting timer 30 (Vmgdrv2: fine problem setup)..
Vbuildops: Fine: (129, 129, 129)
Vbuildops: Operator stencil (lev, numdia) = (1, 4)
Vnm_tstop: stopping timer 30 (Vmgdrv2: fine problem setup).  CPU TIME = 3.731200e-02
Vnm_tstart: starting timer 30 (Vmgdrv2: coarse problem setup)..
Vbuildops: Galer: (065, 065, 065)
Vbuildops: Galer: (033, 033, 033)
Vbuildops: Galer: (017, 017, 017)
Vbuildops: Galer: (009, 009, 009)
Vbuildops: Galer: (005, 005, 005)
Vnm_tstop: stopping timer 30 (Vmgdrv2: coarse problem setup).  CPU TIME = 3.197400e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: solve)..
Vnm_tstop: stopping timer 40 (MG iteration).  CPU TIME = 2.629421e+00
Vprtstp: iteration = 0
Vprtstp: relative residual = 1.000000e+00
Vprtstp: contraction number = 1.000000e+00
Vprtstp: iteration = 1
...
Vprtstp: relative residual = 2.154342e-07
Vprtstp: contraction number = 1.616089e-01
Vnm_tstop: stopping timer 30 (Vmgdrv2: solve).  CPU TIME = 9.568328e+00
Vnm_tstop: stopping timer 28 (Solver timer).  CPU TIME = 1.005055e+01
Vpmg_setPart:  lower corner = (-33.218, -34.918, -46.0575)
Vpmg_setPart:  upper corner = (94.782, 93.082, 81.9425)
Vpmg_setPart:  actual minima = (-33.218, -34.918, -46.0575)
Vpmg_setPart:  actual maxima = (94.782, 93.082, 81.9425)
...
Vgrid_writeDX:  Writing to virtual socket...
Vgrid_writeDX:  Writing comments for ASC format.
Vnm_tstop: stopping timer 26 (APBS WALL CLOCK).  CPU TIME = 1.342371e+01
